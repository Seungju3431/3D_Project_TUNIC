...
{
    [SerializeField] Vector2 m_cycleDurationXZ;
    ...
    private void UpdateMotion()
    {
        ...
        float newZ = m_movementPathX.Evaluate(timeZ + m_movementTimeOffsetXZ.y) * m_movementMagnitudeXZ.y;

        transform.position = m_initialPosition + new Vector3(newX, newZ);
    }
