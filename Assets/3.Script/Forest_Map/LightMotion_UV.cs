...
public class LightMotion_UV : MonoBehaviour
{
    ...
    [SerializeField] Vector2 m_tex2TilingUV = new Vector2(1f, 1f);
    ...
    private void Update()
    {
        ...
        m_time2U = Time.time % m_cycleDuration2UV.y;
        m_time2U /= m_cycleDuration2UV.y;
